...
var snowStorm = (function (window, document) {
    ...
    this.animationInterval = 1020; // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
    ...
    // this.snowCharacters = ["🎄", "⭐️", "❄️", "⛄️"]; // If this array is set, each snowflake will randomly be assigned a character from this array
    ...
    this.SnowFlake = function (type, x, y) {
        ...
        this.o.innerHTML = snowCharacter; //snowCharacters[Math.floor(Math.random() * snowCharacters.length)] || storm.snowCharacter;
        if (storm.className) {
